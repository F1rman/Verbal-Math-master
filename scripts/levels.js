app.run(function($rootScope) {
  ...
  $rootScope.levels = [{
    ...
    },
     {
      ...
      "options": [100, 1000, 200, 1000, ["+"], time, [null], count_operation, 2]
    }, {
